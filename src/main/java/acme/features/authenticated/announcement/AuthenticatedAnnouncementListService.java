...
public class AuthenticatedAnnouncementListService extends AbstractGuiService<Authenticated, Announcement> {
	...
	public void load() {
		...
		objects = this.repository.findAnnouncementsByMoment(deadline);
	...
	public void unbind(final Announcement object) {
		...
		dataset = super.unbindObject(object, "title", "moment", "status");
		super.addPayload(dataset, object, "text", "moreInfo");
