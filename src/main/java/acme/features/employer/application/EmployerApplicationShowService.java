...
@GuiService
public class EmployerApplicationShowService extends AbstractGuiService<Employer, Application> {
	...
	public void authorise() {
		...
		status = application != null && super.getRequest().getPrincipal().hasRealm(application.getJob().getEmployer());
